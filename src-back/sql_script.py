...
agriculture = ["carrot", "potato", "rice", "tomato", "cabbage", "tractor", "wheat", "corn", "lettuce", 
          ...
          "winged", "bean", "amaranth", "quinoa", "sorghum", "safflower", "sesame",
...
b_words = ["bamboo", "basil", "beet", "broccoli", "blueberry", "blackberry", "barley", "banana", 
        ...
        "bandicoot", "burgrass", "bedstraw", "bluebottle", "birdwood", "bellbird", "bullrush", 
        ...
        "barley", "barn", "basil", "beans", "beet", "beekeeping", "belladonna", "berry", "bitter",
        "biodiversity", "birch", "black", "black-eyed", "blue", "bean", "beetroot", "butternut", 
        "boneset", "bottle", "breadfruit", "broom", "broccoli", "bellflower", "beehive", "buttercup"
]
#%%
...
cursor.execute("""INSERT INTO Card (name, effect, rarity, isNegative, adding, multiplyBy)
...
for card in cards:
    ...
    print(f" {card[2]}");
    print(f" Adds: {card[5]} - Multiplies by: {card[6]}");
#%%
